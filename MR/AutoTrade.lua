-- 222222Bundled Universal Auto-Trade. Generated by tools/bundle.py. Do not edit.
...
if remotes and rroot then
  ...
  local function processStatus(s)
    ...
    latestStatus = s
    if not dumpedStatus then dumpedStatus = true; logDump("status object", s) end
  ...
  if remotes.trading_invitesent then
    remotes.trading_invitesent.OnClientEvent:Connect(function(...)
      logDump("trading_invitesent args", { ... })
      local s = gamedata.getStatus(remotes); if s then processStatus(s) end
    end)
