-- Bu22ndled Universal Auto-Trade. Generated by tools/bundle.py. Do not edit.
  ...
  pcall(function()
    ...
    if fw then
      ...
      if ok and type(lib) == "table" then
        local keys = {}
        for k in pairs(lib) do keys[#keys + 1] = tostring(k) end
        log:info("Framework keys: " .. table.concat(keys, ", "), t)
      elseif ok and type(lib) == "userdata" then
        log:info("Framework require -> instance", t)
      else
